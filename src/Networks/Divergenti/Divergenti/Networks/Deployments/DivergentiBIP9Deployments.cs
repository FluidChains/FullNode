...
namespace Divergenti.Networks.Deployments
{
    public class DivergentiBIP9Deployments : BIP9DeploymentsArray
    {
        ...
        /// </summary>
        public DivergentiBIP9Deployments() : base(NumberOfDeployments)
        {
        }
