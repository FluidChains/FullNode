...
using Divergenti.Networks.Policies;
using Divergenti.Networks.Rules;
using NBitcoin;
...
using Blockcore.P2P;
using Divergenti.Networks.Consensus;
using Divergenti.Networks.Setup;
using Divergenti.Networks.Deployments;
using NBitcoin.Protocol;


namespace Divergenti.Networks
{
    public class DivergentiMain : Network
    {
        public DivergentiMain()
        {
            // START MODIFICATIONS OF GENERATED CODE
            var consensusOptions = new DivergentiPosConsensusOptions
            {
            ...
            CoinSetup setup = DivergentiSetup.Instance.Setup;
            NetworkSetup network = DivergentiSetup.Instance.Main;
            ...
            var bip9Deployments = new DivergentiBIP9Deployments
            {
                [DivergentiBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 27, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.DefaultMainnetThreshold),
                [DivergentiBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, BIP9DeploymentsParameters.AlwaysActive, 999999999, BIP9DeploymentsParameters.DefaultMainnetThreshold),
                [DivergentiBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, BIP9DeploymentsParameters.AlwaysActive, BIP9DeploymentsParameters.AlwaysActive, BIP9DeploymentsParameters.DefaultMainnetThreshold)
            };
            ...
            // HashKey Definition
            byte[] newHashkey = Encoders.ASCII.DecodeData("Bitcoin seed");
            ...
            this.StandardScriptsRegistry = new DivergentiStandardScriptRegistry();
        ...
        protected void RegisterRules(IConsensus consensus)
        {
            consensus.ConsensusRules
                ...
                .Register<DivergentiHeaderVersionRule>()
