...
namespace Rutanio.Networks.Rules
{
    /// <summary>
    /// Checks if <see cref="RutanioMain"/> network block's header has a valid block version.
    /// </summary>
    public class RutanioHeaderVersionRule : HeaderVersionRule
    {
        /// <inheritdoc />
        ...
        public override void Run(RuleContext context)
        {
            ...
            // The Rutanio-Qt block validation rules mandate if (!IsProtocolV3(nTime)) && (nVersion > 7), then reject block.
            ...
            // IsProtocolV3(nTime) { return TestNet() || nTime > 1564350120; }

            // The mainnet genesis block has nTime = 1564350120, so V3 is applied immediately and this supersedes V2.
            // The block versions have therefore been version 7 since genesis on Rutanio mainnet.
